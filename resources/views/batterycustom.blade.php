  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" style="padding-top: 100px;">
    <div class="flex items-center justify-between mb-6 relative">
      ...
      <select id="filterSelect" class="form-select ml-auto">
        ...
        <option value="409V 100AH">409V 100AH</option>
        <option value="768V 280AH">768V 280AH</option>
        <option value="896V 100AH">896V 100AH</option>
        <option value="1331.2V 280AH">1331.2V 280AH</option>
      </select>
    </div>
...
-->
    ...
    <!--====== Main js ======-->
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/productcustom.js') }}"></script>
