    ...
    <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" style="padding-top: 120px;">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div>
                <h1 style = "font-size : 32px;font-weight: 700" >APM8-TPLDD132 Series  (645-670W)</h1>
                <br/>
                    <table>
                        <tbody>
                            
                            <tr class="firstRow">
                                <td valign="top" style="word-break: break-all;"><strong>Model #&nbsp;:&nbsp;</strong>&nbsp; APM8-TPLDD132 Series</td>
                            </tr>
                            <tr>
                                <td valign="top" style="word-break: break-all;">
                                <strong>Power Range&nbsp;:&nbsp;&nbsp;</strong>		 645-670W
                                </td>
                                <td valign="top" style="word-break: break-all;"><strong>Maximum Efficiency&nbsp;:&nbsp;&nbsp;</strong>21.57%</td>
                            </tr>
                            <tr>
                                <td valign="top" style="word-break: break-all;"><strong>Yearly Degradation&nbsp;:</strong>&nbsp;&nbsp;0.45%</td>
                            </tr>
                        </tbody>
                    </table>
...
-->
    ...
    <!--====== Main js ======-->
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/product-detailsolar6.js') }}"></script>
