    ...
    <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" style="padding-top: 120px;">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div>
                <h1 style = "font-size : 32px;font-weight: 700" > 25.6V 50Ah LiFePO4 Batteries</h1>
                <br/>
                    <table>
                        <tbody>
                            
                            <tr class="firstRow">
                                <td valign="top" style="word-break: break-all;"><strong>Model #&nbsp;:&nbsp;</strong>&nbsp;24-50</td>
                                <td valign="top" style="word-break: break-all;"><strong> P/N&nbsp;:&nbsp;</strong>DC1280-0050-810</td>
                            </tr>
                            <tr>
