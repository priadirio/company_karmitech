                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <strong>Size&nbsp;:&nbsp;&nbsp;</strong>		 (:mm / inch)4234*2692*3110mm
                                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;166.6*105.95122.44in</p>
                                </td>
                                <td valign="top" style="word-break: break-all;"><strong>Weight&nbsp;:&nbsp;&nbsp;</strong> 315KG/694.45lb</td>
                            </tr>
                            <tr>
...
-->
    ...
    <!--====== Main js ======-->
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/product-detail1331.js') }}"></script>
