    ...
    <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" style="padding-top: 120px;">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div>
                <h1 style = "font-size : 32px;font-weight: 700" >APM7-SH120 (435-440W)</h1>
                <br/>
                    <table>
                        <tbody>
                            
                            <tr class="firstRow">
                                <td valign="top" style="word-break: break-all;"><strong>Model #&nbsp;:&nbsp;</strong>&nbsp; APM7-SH120 Series</td>
                            </tr>
                            <tr>
                                <td valign="top" style="word-break: break-all;">
                                <strong>Power Range&nbsp;:&nbsp;&nbsp;</strong>		 435-450W
                                </td>
                                <td valign="top" style="word-break: break-all;"><strong>Maximum Efficiency&nbsp;:&nbsp;&nbsp;</strong>20.85%</td>
                            </tr>
                            <tr>
...
-->
    ...
    <!--====== Main js ======-->
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/product-detailsolar2.js') }}"></script>
