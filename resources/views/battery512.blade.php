  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" style="padding-top: 100px;">
    <div class="flex items-center justify-between mb-6 relative">
      ...
      <select id="filterSelect" class="form-select ml-auto">
        ...
        <option value="51.2V 100Ah">51.2V 100Ah</option>
        <option value="51.2V 150Ah">51.2V 150Ah</option>
        <option value="51.2V 400Ah">51.2V 400Ah</option>
      </select>
    </div>
...
-->
    ...
    <!--====== Main js ======-->
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/product512.js') }}"></script>
