    ...
    <section class="py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" style="padding-top: 120px;">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div>
                <h1 style = "font-size : 32px;font-weight: 700" >AK3000INV</h1>
                <br/>
                    <table>
                        <tbody>
                            
                            <tr class="firstRow">
                                <td valign="top" style="word-break: break-all;"><strong>Model #&nbsp;:&nbsp;</strong>&nbsp;AK3000INV </td>
                                <td valign="top" style="word-break: break-all;"><strong>P/N&nbsp;:&nbsp;</strong>NV003-0220-110</td>
                            </tr>
                            <tr>
                                <td valign="top" style="word-break: break-all;">
                                <strong>Size&nbsp;:&nbsp;&nbsp;</strong>		 (:mm / inch)590 x 240 x 100mm
                                <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;23.22*9.44*3.93in</p>
                                </td>
                                <td valign="top" style="word-break: break-all;"><strong>Weight&nbsp;:&nbsp;&nbsp;</strong>7.2KG/15.87lb</td>
                            </tr>
                            <tr>
                                <td valign="top" style="word-break: break-all;"><strong>Rated voltage&nbsp;:</strong>&nbsp;&nbsp;240V</td>
                            </tr>
                            <tr>
                                <td valign="top" style="word-break: break-all;"><strong>Input Current（A）&nbsp;:</strong>&nbsp;&nbsp;284A</td>
                            </tr>
                            <tr>
...
-->
    ...
    <!--====== Main js ======-->
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/product-detailacc1.js') }}"></script>
